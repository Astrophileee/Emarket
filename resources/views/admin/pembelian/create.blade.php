...
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal">
    <i class="fas fa-truck-moving"></i> Pilih Pemasok
  </button>
  
  <br>
  <p style="font-size:15px;">
      <b>Nama Pemasok :</b> <span style="font-size: 15px" class="nama_pemasok"></span>
  </p>
  <p style="font-size:15px;">
...
<p style="font-size:15px;">
    <b>Kota :</b><span style="font-size: 15px" class="kota"></span>
</p>

<form class="form-horizontal form-label-left input_mask" action="{{ route('pembelian.store') }}" id="formTransaksi" method="POST">
    @csrf
    <input type="hidden" class="id_pemasok" name="pemasok_id">
...
<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel">Pilih Pemasok</h5>
          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
        <div class="modal-body">
            <div class="x_content">
                                ...
                                <tbody>
                                    @foreach ($pemasok as $p)
                                        <tr>
                                            ...
                                            <td>
                                                <button type="button" class="btn btn-primary" onclick="changePembelian(event)" data-id="{{ $p->id }}" data-pemasok="{{ $p->kode_pemasok }}" data-nama="{{ $p->nama_pemasok }}" data-alamat="{{ $p->alamat }}" data-kota="{{ $p->kota }}" data-notelp="{{ $p->no_telp }}" data-bs-dismiss="modal">
                                                  <span class="fw-bold me-1">&plus;</span> Pilih
                                                </button>
                                              </td>
                                    @endforeach
...
@push('script')
  ...
  <script>
    const Id = document.querySelector('.id_pemasok')
    const Nama = document.querySelector('.nama_pemasok')
